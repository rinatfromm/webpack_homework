...
const data = [
  { id: 1, title: "Rain", img: rain, icon: cloudRain, color: "#4a90e2", sound: rainSound },
  { id: 2, title: "Summer", img: summer, icon: cloudSnow, color: "#f9d423", sound: summerSound },
  { id: 3, title: "Winter", img: winter, icon: sun, color: "#8ec6e6", sound: winterSound },
];
